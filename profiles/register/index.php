...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title><?php echo $board_title ?> - <?php echo $locale_register ?></title>
  ...
  <body>
    <div id="page" class="mt-0 container stage0">
      ...
      <!-- SUBHEADER START -->
      <div id="installdiv"><h2><?php echo $locale_register ?></h2><div class="alert alert-info"><?php echo $board_msg ?></div>
      <!-- SUBHEADER START -->
      ...
      <form method="post">
        ...
        <br>
        <button class="btn btn-primary ml-1 flex-grow-0 mr-auto" name="register" id="register" type="submit"><?php echo $locale_register ?></button>
      </form>
      <!-- FORM END -->
